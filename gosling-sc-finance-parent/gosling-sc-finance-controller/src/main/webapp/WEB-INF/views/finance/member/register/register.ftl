	...
	<input type="hidden" value="1" name="optType">
	  <div class="form-group">
	   ...
	   <div class="form-group">
	    ...
	    <div class="col-sm-10">
	      <input type="text" class="form-control" name="jiedianNum" id="jiedianNum" readonly="readonly" value="${(members_3.memNum)!'admin'}">
	      <!-- 隐藏接点人ID -->
	      <input type="hidden" name="jiedianId" value="${(members_3.id)!'1'}">
	    </div>
	  </div>
	   <div class="form-group">
	    <label for="firstname" class="col-sm-2 control-label">推荐人编号</label>
	    <div class="col-sm-10">
	      <input type="text" class="form-control" name="tjrNum" id="tjrNum" readonly="readonly" value="${(member.memNum)!''}">
	    </div>
	  </div>
	</form>
</div>
...
$(function(){
	 ...
	 $("#submitbtn").click(function(){
		...
		if (!isUsername(memNum)) {
			layer.msg("会员编号由6-12位数字或字母组成",{time:1000});
			$("#memNum").focus();
			return false;
		 }
