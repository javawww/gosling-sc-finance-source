...
public class ResourceUtil {
	...
	private static final ResourceBundle bundle = java.util.ResourceBundle.getBundle("properties-config/sysConfig");
	...
	public static final Map<Object, Object> getConfigMap(String path) {
		...
		return StringUtil2.SetToMap(set);
	}
    ...
    public static void main(String[] args) {
    	String val = ResourceUtil.getConfigByName("picServerPath");
